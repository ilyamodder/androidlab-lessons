...
import ru.ilyamodder.weathersync.activity.WeatherActivity;
 ...
 */
public class CitiesList extends SwipeToRefreshList implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListAdapter = new CursorBinderAdapter(getActivity(), R.layout.li_city);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        if (id == R.id.cities_loader) {
            return new CursorLoader(
                    ...
                    CitiesProvider.URI, null, null, null, null
            );
        }
        return null;
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        if (loader.getId() == R.id.cities_loader) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra(WeatherActivity.EXTRA_FEED_ID, id);
    ...
    public void dismissView(View view, int position) {
        ...
        if (feed.moveToPosition(position)) {
            getActivity().getContentResolver().delete(
                    CitiesProvider.URI, CitiesProvider.Columns._ID + "=?",
                    new String[]{String.valueOf(CitiesProvider.getId(feed))}
            );
        }
    }
